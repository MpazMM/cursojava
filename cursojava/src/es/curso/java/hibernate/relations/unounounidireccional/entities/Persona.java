...
public class Persona implements Serializable
{
    ...
    //Usando las anotaciones de JPA tenemos un numero menor de operaciones que con los archivos de mapeo. De hecho solo tenemos: merge,persist,refresh,remove,all
