...
public class ArchivoServicio {
	...
	private static final Logger logger = LogManager.getLogger(ArchivoServicio.class);
        ...
        if(dir.isDirectory()) {
        	...
        	for (String nombreFichero : ficheros) {
				...
				if(file.isDirectory()) {
					...
					System.out.println("Es un fichero" + " " + file.length() + " " + file.canExecute() + " " + file.canRead() + " " + file.canWrite());
				}
