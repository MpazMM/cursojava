package es.curso.java.hibernateprofe.basics.daos;
...
import es.curso.java.hibernateprofe.basics.entities.Alumno;
import es.curso.java.hibernateprofe.basics.enums.AlumnoEnum;
import es.curso.java.hibernateprofe.util.JpaUtil;
