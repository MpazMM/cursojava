...
public abstract class VehiculoGuerra implements Tripulable {
	 ...
	 * @param puntosVida
	 */
	public VehiculoGuerra(String nombre, int ataque, int defensa, List<Guerrero> guerreros, int puntosVida) {
		super();
		this.nombre = nombre;
		this.ataque = ataque;
		this.defensa = defensa;
	...
	public void embarcarGuerrero (Guerrero guerrero) throws UnidadesPermitadasException {
