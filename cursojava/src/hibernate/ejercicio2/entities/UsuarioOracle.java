...
public class UsuarioOracle {
	 ...
	 * @param fechaAlta
	 */
	public UsuarioOracle(String nombre, String apellidos, String dni, Date fechaAlta) {
		super();
		this.nombre = nombre;
	 ...
	 * @param fechaAlta
	 */
	public UsuarioOracle(long id, String nombre, String apellidos, String dni, Date fechaAlta) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.apellidos = apellidos;
